      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="card !p-6 bg-white border-2 border-emerald-200 shadow-lg">
          <div className="flex justify-between items-center gap-4">
            ...
            <Link href="/user/deposit">
              <button className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold h-12 px-6 rounded-button transition-all shadow-lg hover:shadow-xl flex items-center gap-2 whitespace-nowrap">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="card !p-5 bg-emerald-50 border-2 border-emerald-200">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-bold text-emerald-900 mb-1">Plan Information</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {plans.map((plan) => {
              ...
              return (
                <div
                  key={plan.id}
                  className={`card !p-6 hover:shadow-xl transition-all border-2 ${
                    plan.isActive ? 'border-emerald-200 hover:border-emerald-600' : 'border-neutral-200 opacity-60'
                  }`}
                >
                  {/* Plan Header */}
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-12 h-12 bg-emerald-600 rounded-xl flex items-center justify-center shadow-md">
                          <span className="text-white font-bold text-xl">{plan.planNumber}</span>
                        </div>
                        <div>
                          <h3 className="text-2xl font-bold text-emerald-600">
                            {planName}
                          </h3>
                          <p className="text-xs text-neutral-500">Plan {plan.planNumber}</p>
                        </div>
                      </div>
                  ...
                  <div className="space-y-3 mb-5">
                    ...
                    <div className="bg-green-50 rounded-lg p-3 mt-3 border-2 border-green-200">
                  ...
                  {plan.isActive ? (
                    <button
                      ...
                      className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold h-12 px-6 rounded-button transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                    ...
                    <button className="w-full h-12 bg-neutral-200 text-neutral-500 font-bold rounded-button cursor-not-allowed" disabled>
