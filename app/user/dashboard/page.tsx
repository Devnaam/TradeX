  ...
  return (
    <div className="min-h-screen bg-background pb-20">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500">{data.user.phone}</p>
              </div>
            </div>
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-foreground hover:text-emerald-600 border border-neutral-300 rounded-button hover:border-emerald-600 transition-all"
            >
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="card !p-6 bg-emerald-600 text-white border-0 shadow-xl">
          ...
          <div className="space-y-3">
            <div className="bg-white/10 rounded-lg p-3 border border-white/20">
              <div className="flex justify-between items-center">
                <span className="text-sm text-white/90">Total Recharge</span>
            ...
            <div className="bg-white/10 rounded-lg p-3 border border-white/20">
              <div className="flex justify-between items-center">
                <span className="text-sm text-white/90">Total Withdraw</span>
                <span className="text-xl font-bold">{formatCurrency(data.wallet.totalWithdraw)}</span>
              </div>
            </div>

            <div className="bg-white rounded-lg p-4 border-2 border-white">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-emerald-600">Available Income</span>
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <div className="card text-center !p-5 hover:shadow-lg transition-shadow border-2 hover:border-emerald-600">
            <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-emerald-600/10 flex items-center justify-center">
              <svg className="w-6 h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <p className="text-3xl font-bold text-foreground mb-1">{data.stats.activePlans}</p>
          ...
          <div className="card text-center !p-5 hover:shadow-lg transition-shadow border-2 hover:border-emerald-600">
            ...
            <p className="text-3xl font-bold text-foreground mb-1">{data.stats.totalReferrals}</p>
        ...
        <div className="card !p-5">
          <h3 className="text-section-title mb-4 flex items-center gap-2 text-foreground">
          ...
          <div className="grid grid-cols-3 gap-3">
            <Link href="/user/deposit/history" className="block group">
              <div className="p-4 bg-background hover:bg-white border border-neutral-200 hover:border-emerald-600 rounded-button text-center transition-all">
        ...
        <div className="card !p-6 bg-emerald-600 text-white border-0 shadow-xl">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-white/20 flex items-center justify-center border-2 border-white/30">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
              </svg>
            </div>
            
            <p className="text-sm text-white/90 mb-2 font-medium">Your Referral Code</p>
            <div className="bg-white/20 rounded-lg px-6 py-3 mb-3 inline-block border border-white/30">
              <p className="text-3xl font-bold tracking-wider">{data.user.referralCode}</p>
            </div>
            
            <p className="text-sm text-white/90 mb-4 flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="w-full bg-white text-emerald-600 hover:bg-white/90 font-bold h-11 px-6 rounded-button transition-all flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
