        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl border border-slate-200 p-4 sm:p-6 md:p-8">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <div className="flex justify-end">
              <a href="#" className="text-xs sm:text-sm text-emerald-600 hover:text-emerald-700 font-medium transition-colors">
                Forgot Password?
              </a>
            </div>
          ...
          <div className="relative my-5 sm:my-6">
            ...
            <div className="relative flex justify-center text-xs sm:text-sm">
              <span className="px-3 sm:px-4 bg-white text-slate-500">New to TradeX?</span>
            </div>
          </div>
